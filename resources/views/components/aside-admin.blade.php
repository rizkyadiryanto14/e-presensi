<aside
    ...
    <nav class="p-4 space-y-1">
        ...
        <!-- Laporan - Hanya Admin dan Bendahara -->
        @if(auth()->user()->hasRole(['admin', 'bendahara']))
...
{{--            <a @click="currentMenu = 'pengguna'" :class="currentMenu == 'pengguna' ? 'active' : ''" href="{{ route('admin.user-management.index') }}" class="sidebar-item flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300">--}}
